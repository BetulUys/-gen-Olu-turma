...
public class UcHarfliUniq {
    public static void main(String[] args) {
        ...
        System.out.println(isim.length()==3?
                ((isim.substring(0,1)!=isim.substring(1,2)&&isim.substring(0,1)!=isim.substring(2,3)&&isim.substring(1,2)!=isim.substring(2,3))?
                        "3 harfli Uniq ": "3 harfli uniq değil"):"uniq değil");//düzgün çalışmıyor sor
